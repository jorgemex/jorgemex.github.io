...
(function (ui) {
    ...
    (function (controls) {
        ...
        controls.calendarValue = calendarValue;
        function calendar() {
            let element = this;
            ...
            if (element.property("years") == null) {
                ...
                gText
                    ...
                    years)
                    .attr("fill", "#FFF");
                element.property("value", (day.toString().length < 2 ? "0" + day : day) +
                    "/" +
                    (month.toString().length < 2 ? "0" + month.toString() : month) +
                    "/" +
                    years);
                element.property("date", years +
                    "-" +
                    (month.toString().length < 2 ? "0" + month.toString() : month) +
                    "-" +
                    ...
                    if (m >= initial && dat <= maximum) {
                        ...
                        let _gContenido = gCont
                            ...
                            element.property("date", years +
                                ...
                                " 00:00:00");
                            element.property("value", (da.length < 2 ? "0" + da : da) +
                                "/" +
                                (month.toString().length < 2
                                    ? "0" + month.toString()
                                    : month) +
...
//# sourceMappingURL=calendr.js.map